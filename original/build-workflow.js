...
const transformSrc = inlineable(read("original/transform.js"));
const pureSrc = inlineable(read("original/pure-pdf.js"));
...
const nodes = [
  ...
  },
  {
    ...
    position: [-400, 300],
    notes:
      "Editable filter, no code changes needed. Min_Overdue_Balance: only customers whose net past-due balance is at least this amount (e.g. 1000) get a letter + statement.",
  },
  {
    parameters: {
      assignments: {
...
const workflow = {
  name: "Printing Letter_Invoices  Original",
  nodes,
  connections,
  active: false,
...
const outPath = path.join(__dirname, "Printing_Letter_Invoices_Original.workflow.json");
